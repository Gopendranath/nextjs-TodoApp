  ...
  return (
    <>
      ...
      <form onSubmit={onSubmitHandler} className="flex items-start flex-col gap-2 w-[80%] max-w-[600px] mt-24 px-2 mx-auto">
        ...
        <button type="submit" className="bg-orange-600 py-3 px-11 text-white rounded">Add ToDo</button>
      </form>


      <div className="relative overflow-x-auto mt-24 w-[60%] mx-auto rounded-md">
